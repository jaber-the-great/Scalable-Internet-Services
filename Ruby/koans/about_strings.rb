...
EOS
  ...
  def test_the_shovel_operator_modifies_the_original_string
    ...
    # beacuse the shovel operator would append a string directly to the 
    # end of an existing string, it modifies the original string in place.
    # This is more memory efficient and faster. The += would create a new
    # string. It does not modify the original string, but creates a new one 
    # and assign it again to the prevuios string.
  end
